...
public class Contexto extends javax.swing.JFrame {
    ...
    public float calcularArea()
    {
        if(rbCirculo.isSelected()){
           setEstrategia(new Circulo(Float.parseFloat(campoRadio.getText())));
        }
        if(rbTriangulo.isSelected()){
           setEstrategia(new Triangulo(Float.parseFloat(campoAltura.getText()),Float.parseFloat(campoBase.getText())));
        }
